...
import static com.droukos.newsservice.environment.constants.FieldNames.*;
import static com.droukos.newsservice.environment.constants.Fields.*;
...
public enum Warnings {
    ...
    PASSWORD_INVALID(PASSWORD + INVALID.getShortWarning(), " Password must be over 5 characters length " +
    ...
    PROBLEMS_TITLE_EMPTY(PROBLEMS_TITLE + EMPTY.getShortWarning(), "Not given problem title"),
    PROBLEMS_TITLE_INVALID(PROBLEMS_TITLE + INVALID.getShortWarning(), "Not valid problem title"),

    PROBLEMS_INFO_LENGTH(PROBLEMS_INFO +INVALID.getShortWarning(), "Wrong info length"),
    PROBLEMS_INFO_EMPTY(PROBLEMS_INFO + EMPTY.getShortWarning(), "Empty info"),
    PROBLEMS_INFO_INVALID(PROBLEMS_INFO + INVALID.getShortWarning(), "Wrong info/spam"),
    ;
